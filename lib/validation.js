...
//TODO: Do I really need to use object-path library?
_.mixin({
  deepEach: function (object, callback) {
...
function ValidationPipeline(pipeline) {
  this.pipeline = !_.isArray(pipeline) ? [pipeline] : pipeline;
  ...
  this.pipeline.forEach(function (pipeline) {
    ...
    pipelineKeys.forEach(function (pipelineKey) {
      if (this[pipelineKey] instanceof Function) {
        ...
        var dummy = {};
        dummy[pipelineKey] = pipeline[pipelineKey];
        this.$schema(object, dummy);
      }
    }, this);
 ...
 * @param specs
 */
ValidationPipeline.prototype.$strict = function (object, specs) {
  this.strict = !!specs;
};
...
ValidationPipeline.prototype.$schema = function (object, specs) {
  ...
  if (this.strict) {
    ...
    _.deepEach(object, function (value, keyPath) {
