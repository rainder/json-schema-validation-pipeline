...
ValidationPipelineMethods.$schema = function (object, specs) {
  ...
  if (this.strict && this.strict.enabled) {
 ...
 */
function deepEach(object, callback, maxLevel) {
  (function traverseObject(object, path, level) {
    ...
    _.each(object, function (value, key) {
      ...
      if (_.isObject(value)) {
        traverseObject(value, keyPath, level + 1);
      }
    });
  })(object, '', 1);
}