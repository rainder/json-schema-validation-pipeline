...
function checkNumber(key, value, spec, object) {
  ...
  if (spec.hasOwnProperty('fn')) {
    return spec.fn.call(this, value, key, object);
  }
...
function checkArray(key, value, spec, object) {
  ...
  if (spec.hasOwnProperty('typeOf')) {
    for (var x in value) {
      ...
      if (itemType === Number) {
        var result = checkNumber.call(this, key + '.' + x, value[x], itemSpec, object);
        if (result !== true) {
          return result;
        }
      }
      ...
      if (itemType === String) {
        var result = checkString.call(this, key + '.' + x, value[x], itemSpec, object);
        if (result !== true) {
          return result;
        }
      }
      ...
      if (itemType === Object) {
        var result = checkObject.call(this, key + '.' + x, value[x], itemSpec, object);
        if (result !== true) {
          return result;
        }
      }
      ...
      if (itemType === Boolean) {
        var result = checkBoolean.call(this, key + '.' + x, value[x], itemSpec, object);
        if (result !== true) {
          return result;
        }
      }
      ...
      if (itemType === Array) {
        var result = checkArray.call(this, key + '.' + x, value[x], itemSpec, object);
        if (result !== true) {
          return result;
        }
      }
